...
function loginafter_1610585974(res, htmlObj, before_display, ey_login_vertify_display, third_party_login_display, third_party_wxlogin_display, third_party_wblogin_display, third_party_qqlogin_display)
{
    ...
    if (1 == res.code) {
        ...
        if (1 == res.data.ey_is_login) {
            ...
            if (0 == res.data.is_mobile) {
                if (1 != getCookie_1610585974('close_bind_mobile')) {
                    layer_bind_mobile_1610585974(res.data.root_dir);
                }
            }
        } else {
            /*图形验证码*/
 ...
 */
function layer_bind_mobile_1610585974(root_dir) {
    var title = '绑定手机';
    var url = root_dir+"/index.php?m=user&c=Users&a=bind_mobile";
    if (url.indexOf('?') > -1) {
        url += '&';
    } else {
        url += '?';
    ...
    layer.open({
        ...
        content: url
        ,cancel: function(){
            setCookies_1610585974('close_bind_mobile', 1);
            $.ajax({
                url: root_dir+"/index.php?m=user&c=Users&a=record",
                type: 'POST',
                data: {bind_mobile:1,_ajax:1},
                success: function(res){
 ...
 */
function setCookies_1610585974(name, value, time)
{
...
var tag_user_result_json = {"carturl":"\/index.php?m=user&c=Shop&a=shop_cart_list","userurl":"\/user\/index","regurl":"\/reg","loginurl":"\/login","htmlid":$('.userinfo_htmlid').attr('id'),"loginPopupId":" id='ey_login_id_v665117' ","root_dir":""};
